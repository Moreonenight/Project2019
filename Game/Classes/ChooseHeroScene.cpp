...
bool ChooseHeroScene::init()
{
	...
	auto HouYi = MenuItemImage::create("HouYi/Choose.png", "HouYi/Choose.png");
	HouYi->setScale(0.5f);
	...
	auto Yase = MenuItemImage::create("Yase/Choose.png","Yase/Choose.png");
	Yase->setScale(0.5f);
	...
	auto Daji = MenuItemImage::create("Daji/Choose.png", "Daji/Choose.png");
	Daji->setScale(0.5f);
